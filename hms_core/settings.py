...
#         'NAME': 'project_db',       # Your MySQL DB name
#         'USER': 'root',             # Default XAMPP MySQL user
#         'PASSWORD': '',             # Leave blank if no password (default for XAMPP)
...
# For production (example using Gmail - replace with your provider's settings):
# EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
# EMAIL_HOST = 'smtp.gmail.com'
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'your_email@gmail.com'  # Your Gmail address
# EMAIL_HOST_PASSWORD = 'your_app_password'  # Your Gmail app password (more secure than regular password)
